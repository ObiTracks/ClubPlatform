    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('P', 'Profile'), ('TL', 'Team Lead'), ('E', 'Executive'), ('VP', 'Vice President'), ('P', 'President')], default='M', max_length=40)),
                ('date_created', models.DateTimeField(auto_now=True)),
                ('clubs', models.ManyToManyField(blank=True, default=None, to='mainplatform.Club')),
            ],
        ),
        migrations.CreateModel(
            name='School',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='mainplatform.event')),
            ],
        ),
        migrations.CreateModel(
            name='Resource',
        ...
        migrations.AddField(
            model_name='profile',
            name='school',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='mainplatform.school'),
        ),
        migrations.AddField(
            model_name='profile',
            name='user',
